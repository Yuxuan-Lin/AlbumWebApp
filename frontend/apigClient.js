...
apigClientFactory.newClient = function (config) {
    ...
    // var invokeUrl = 'https://stxmrqubth.execute-api.us-east-1.amazonaws.com/v1';
    var invokeUrl = 'https://8opuxqk3ca.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.search1Get = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['q'], ['body']);
        
        var search1GetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/search_1').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['q']),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(search1GetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.search1Options = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var search1OptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/search_1').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(search1OptionsRequest, authType, additionalParams, config.apiKey);
    };
